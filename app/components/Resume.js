    ...
    <section id={id} className={styles.section}>
      ...
      <div className={styles.resumeContent}>
        <div className={styles.resumeText}>
          <h3 className={styles.h3}>Quality Assurance Engineering Co-op at Carbonite, Inc. <br/>(Jan. 2020 - Apr. 2020)</h3>
          ...
          <h3 className={styles.h3}>IT Support Analyst Co-op at Harvard Business Publishing  <br/>(Jan. 2019 - June. 2019)</h3>
          ...
          <h3 className={styles.h3}>Graphic Designer at Nomads Dance Team  <br/>(Sep. 2019 - Apr. 2022)</h3>
          ...
          <h3 className={styles.h3}>Chairperson at District One  <br/>(Jan. 2018 - Jun. 2021)</h3>
          ...
          <h3 className={styles.h3}>National Director & Conference Finance Director at FIND, Inc.  <br/>(Jan. 2019 - Nov. 2020)</h3>
          ...
          <h3 className={styles.h3}>External Public Relations Officer at NU Barkada  <br/>(Apr. 2018 - Apr. 2019)</h3>
